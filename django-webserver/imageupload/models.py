...
class Transfer(models.Model):
    ...
    person_image_segmentation = models.ImageField(upload_to='images/', default="loading.gif")
    style_transfered = models.ImageField(upload_to='images/', default="loading.gif")
